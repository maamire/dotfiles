...
--theme.taglist_bg_focus = "#ff0000"
    ...
    theme.taglist_height  = 20
    theme.taglist_width   = 20


    theme.taglist_bg_normal = theme.bg_normal
    theme.taglist_fg_urgent = "#EEEEEE"
    ...
    theme.wibar_width  = (2560 - theme.useless_gap*3)
    theme.wibar_margin = 10
...
theme.layout_max = themes_path.."default/layouts/maxw.png" theme.layout_fullscreen = themes_path.."default/layouts/fullscreenw.png"
