...
-- =======================================================
    ...
    calendar.create = function(s)
        ...
        local month_calendar = awful.widget.calendar_popup.month({
            ...
            style_header = {border_width = 0, bg_color="#000000"},
            style_weekday = {border_width = 0, bg_color="#000000"},
            style_normal = {border_width = 0, bg_color="#000000"},
            style_focus = {border_width = 0, bg_color = beautiful.bg_focus_green},
        })
